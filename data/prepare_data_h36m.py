# This file is modified from https://github.com/facebookresearch/VideoPose3D/blob/main/data/prepare_data_h36m.py
...
if __name__ == '__main__':
    ...
    if args.from_archive:
        ...
        for subject in subjects:
            output[subject] = {}
            file_list = glob('h36m_SemGCN/' + subject + '/MyPoses/3D_positions/*.h5')
            # file_list = glob(args.from_archive + '/' + subject + '/MyPoses/3D_positions/*.h5')
        ...
        np.savez_compressed(args.from_archive + '/' + output_filename, positions_3d=output)
    ...
    dataset = Human36mDataset(args.from_archive + '/' + output_filename + '.npz')
    output_2d_poses = {}
